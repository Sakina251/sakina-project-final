...
const Signup = () => {
    return (
        <div className='  form-container mt-5 pt-5 text-center text-light'>
            ...
            <h3>Get started with <img src="https://bootstrapious.com/i/snippets/sn-nav-logo/logo.png" width="30" alt="" class="d-inline-block align-middle mr-2"></img>Stree today! </h3>
            <div className='mt-3  d-flex justify-content-center align-items-center'>

                <div>
                    <div className='row  signup-container'>
                        <div className='col-md-4 social-container py-5 px-5'>
                            <h2 className=' text-start'><img src="https://bootstrapious.com/i/snippets/sn-nav-logo/logo.png" width="30" alt="" class="d-inline-block align-middle mr-2"></img>Stree</h2>
